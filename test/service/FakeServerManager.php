...
class FakeServerManager extends EventListener
{
    const PORT = 32345;
     ...
     * {@inheritdoc}
     *
     * @see \MLocati\Vies\Test\Service\EventListenerBase::doStartTestSuite()
     */
     ...
     * {@inheritdoc}
     *
     * @see \MLocati\Vies\Test\Service\EventListenerBase::doStartTest()
     */
     ...
     * {@inheritdoc}
     *
     * @see \MLocati\Vies\Test\Service\EventListenerBase::doEndTestSuite()
     */
    ...
    private function startFakeServer()
    {
        ...
        $process = new Process(
            ...
            // $cwd
            ML_VIES_TEST_ROOTDIR . '/fake-server',
            // $env
            null,
            // $input
            null,
