...
namespace MLocati\Vies\CheckStatus;
...
class Response
{
    ...
    /**
     * @var \MLocati\Vies\CheckStatus\Response\VowStatus|null
     */
    private $vowStatus;
    ...
    /**
     * @var \MLocati\Vies\CheckStatus\Response\CountryStatus[]
     */
    ...
    /**
     * @return \MLocati\Vies\CheckStatus\Response\VowStatus
     */
     ...
     *
     * @return \MLocati\Vies\CheckStatus\Response\CountryStatus|null
     */
     ...
     * return array
     */
    protected function getCountryCodesMap()
    {
     ...
     * @return string[]
     */
    protected function extractCountryCodesMap()
    {
