...
namespace MLocati\Vies\CheckVat;
...
class Response
{
     ...
     * @return string
     *
     * @see \MLocati\Vies\CheckVat\Response::MATCH_VALID
     * @see \MLocati\Vies\CheckVat\Response::MATCH_INVALID
     * @see \MLocati\Vies\CheckVat\Response::MATCH_NOT_PROCESSED
     */
     ...
     * @return bool|null
     */
    protected function extractBool($key)
    {
